...
public final class BpReadingFinderException extends Exception {
  public BpReadingFinderException (String message) { 
      super(message); 
  } 
  public BpReadingFinderException(Exception e) { 
      super(e); 
  } 
  public  BpReadingFinderException(String msg, Exception e) {  
      super(msg, e);  
  }  
} 
